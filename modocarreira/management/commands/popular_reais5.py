...
class Command(BaseCommand):
    help = 'Popula a base de dados com Campeonatos e Jogadores REAIS e ATUAIS de 11 ligas internacionais (v2 - mais completa).'

    def handle(self, *args, **kwargs):
        self.stdout.write(self.style.WARNING('A abrir o mapa-múndi do futebol para o Metaverso (v2 - edição ampliada)...'))
            ...
            'Serie A (Itália)': {
                'codigo': 'ITA', 'clubes': {
                    ...
                    'Como': {'sigla': 'COM', 'prestigio': 74, 'orcamento': 260000, 'jogadores': [
                        ('Nico Paz', 'AM', 82), ('Patrick Cutrone', 'ST', 76),
                    ]},
                }
            },
            'Bundesliga (Alemanha)': {
